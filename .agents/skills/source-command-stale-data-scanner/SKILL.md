---
name: "source-command-stale-data-scanner"
...
# source-command-stale-data-scanner

Use this skill when the user asks to run the migrated source command `stale-data-scanner`.
