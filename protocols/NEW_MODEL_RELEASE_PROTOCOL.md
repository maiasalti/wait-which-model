...
- Knowledge cutoff (null if unpublished), modality, `type` (`llm`, or `system-one` for a typed-decision model that returns probabilities rather than text), open weights or not
