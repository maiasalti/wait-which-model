...
Stats-filler sweep on 2026-09-24 (daily sweep, unattended). WebFetch was denied for every URL this session; findings rest on WebSearch excerpts of primary pages (artificialanalysis.ai model pages and the "Benchmarking Grok 4.7" article, arcprize.org results pages, arena.ai leaderboard/changelog and Arena's X posts), cross-checked across independent outlets (mixed-news, beri.net, OfficeChai). Every open cell on models released since 2026-03-24 was already in this ledger; only the re-check rows were revisited. One fill: `grok-4-7` costPerTask $2.73 at high (AA's high-effort page; xhigh $3.74 recorded in notes). The arena.ai Text Arena board is still on its 2026-09-13 update (402 models, 8,146,274 votes) and Arena's own X post says Opus 5.5 is in Battle Mode for Text but not yet ranked, so every lmarenaElo re-check row above (claude-opus-5-5, gpt-6-sol, gpt-6-luna, mimo-v2-6-pro, mimo-v2-6-flash, grok-4-7, step-5-preview, kimi-k2-8-preview, qwen3-8-omni-flash, atria-dawn-preview, fugu-max, fugu-ultra-v2, hy4-preview) stands unchanged — re-check once the board's update date moves past 2026-09-13.
