...
| deepseek-v4-pro-0813 | mmluPro / aime / lmarenaElo / arcAgi2 | 2026-08-15 | absent from DeepSeek's self-reported launch table (which covers GPQA Diamond, SWE-bench Verified, Terminal-Bench 2.1 and HLE); no arena.ai listing, and no third-party evaluator had replicated any V4-Pro-0813 figure at the time of this check |
| gemini-3-7-flash | mmluPro / gpqaDiamond / sweBench / aime / hle / lmarenaElo / arcAgi2 | 2026-08-15 | Google's model card reports FrontierCode, DeepSWE, Code Arena, Terminal-Bench 2.1/3.0, AutomationBench, Harvey LAB-AA, GDP.pdf, CharXiv, LVBench, GDM-MRCR, OSWorld, Agent's Last Exam, BioMysteryBench and LABBench2 — none of the missing keys; HLE is reported only as HLE-Verified (53.6%), a cleaned subset not comparable to the full exam tracked here, so deliberately not recorded |
