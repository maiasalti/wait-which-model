...
export const alt = "Get an email when a new frontier AI model is released, from Wait Which Model?";
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{ width: 10, height: 10, borderRadius: 10, backgroundColor: ACCENT }} />
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 78, lineHeight: 1.05, color: INK, letterSpacing: -2 }}>
            New model alerts
          </div>
          <div style={{ marginTop: 28, fontSize: 31, lineHeight: 1.4, color: INK_2, maxWidth: 940 }}>
            One email whenever a new frontier AI model is released, with a link to its
            scores and pricing.
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex" }}>Unsubscribe in one click</div>
        </div>
      </div>
    ),
    size,
